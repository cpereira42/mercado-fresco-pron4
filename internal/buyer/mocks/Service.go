...
func (_m *Service) Create(card_number_ID string, first_name string, last_name string) (buyer.Buyer, error) {
...
func (_m *Service) GetId(id int) (buyer.Buyer, error) {
	ret := _m.Called(id)
...
func (_m *Service) Update(id int, card_number_ID string, first_name string, last_name string) (buyer.Buyer, error) {
