...
-- -----------------------------------------------------
-- Table `mercadofresco`.`employee`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mercadofresco`.`employee` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `card_number_id` VARCHAR(255) NOT NULL,
  `first_name` VARCHAR(255) NOT NULL,
  `last_name` VARCHAR(255) NOT NULL,
...
-- -----------------------------------------------------
-- Table `mercadofresco`.`seller`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mercadofresco`.`seller` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `cid` VARCHAR(255) NOT NULL,
  `company_name` VARCHAR(255) NOT NULL,
  `address` VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mercadofresco`.`products` (
  ...
  CONSTRAINT `fk_product_seller1`
    ...
    REFERENCES `mercadofresco`.`seller` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb3;
...
CREATE TABLE IF NOT EXISTS `mercadofresco`.`inbound_orders` (
  ...
  CONSTRAINT `fk_inbound_details_employee1`
    ...
    REFERENCES `mercadofresco`.`employee` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
